    ...
    <div class="container-fluid">
        ...
        <div class="col-md-4">
            <div class="container slideshow">
                <div>
                    <img src="images/stealth-game/models-mini.png" alt="Stealth Game Picture" title="Stealth Game"/>
                </div>
                <div>
                    <img src="images/stealth-game/central-area-mini.png" alt="Stealth Game Picture" title="Stealth Game"/>
                </div>  
                <div>
                    <img src="images/stealth-game/starting-area-mini.png" alt="Stealth Game Picture" title="Stealth Game"/>
                 </div>
                <div>
                    <img src="images/reds-adventure/red-jumping-mini.png" alt="Reds Adventure Game" title="Reds Adventure"/>
                </div>
                <div>
                    <img src="images/reds-adventure/red-attacking-mini.png" alt="Reds Adventure Game" title="Reds Adventure"/>
                </div>
            </div>
        </div>
        -->
